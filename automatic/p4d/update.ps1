...
$releaseNotesUrl = 'https://www.perforce.com/perforce/doc.current/user/relnotes.txt'
$baseUrl = 'http://filehost.perforce.com/perforce/r'
$x86Path = 'bin.ntx86'
$x64Path = 'bin.ntx64'
$checksumsFileName = 'SHA256SUMS'
$x86FileName = 'helix-versioning-engine-x86.exe'
$x64FileName = 'helix-versioning-engine-x64.exe'
